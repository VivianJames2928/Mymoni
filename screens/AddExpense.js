        ...
        <SafeArea>
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text styles={styles.headerText}>Track an Expense</Text>
                </View>
                ...
                style={{paddingVertical:Theme.sizes[2],FontSize:Theme.fonts.fontSizePoint.title,marginBottom:Theme.sizes[2],marginBottom:Theme.sizes[2]}}
                ...
                outlineColor={Theme.colors.red500}
                activeOutlineColor={Theme.colors.red700}
                style={{paddingVertical:Theme.sizes[2],FontSize:Theme.fonts.fontSizePoint.title}}
                multiline={true}/>
             <Button 
                color={Theme.colors.red700}
                mode="contained"
